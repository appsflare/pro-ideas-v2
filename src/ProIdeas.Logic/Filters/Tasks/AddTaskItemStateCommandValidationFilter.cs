...
{
    public class AddTaskItemStateCommandValidationFilter : BaseMessageValidationFilter<AddTaskItemStateCommand>
    {
        private readonly IUserIdentityProvider _userIdentityProvider;
        private readonly IRepository _repository;
        public AddTaskItemStateCommandValidationFilter(IUserIdentityProvider userIdentityProvider, IRepository repository)
        {
            _userIdentityProvider = userIdentityProvider;
            _repository = repository;
        }

        async protected override Task Validate(FilterContext<AddTaskItemStateCommand> context)
        {
