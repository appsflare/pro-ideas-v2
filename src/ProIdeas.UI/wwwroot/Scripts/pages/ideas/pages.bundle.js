this[''] = this[''] || {};
this['']['/Scripts/pages/ideas/pages'] = this['']['/Scripts/pages/ideas/pages'] || {};
(function () {
'use strict';
...
var PagesViewModel = function () {
    ...
    createClass(PagesViewModel, [{
        ...
        key: 'isCurrentPage',
        value: function isCurrentPage(page) {
...
var navigationHelper = {
    ...
    toTeamDetails: function toTeamDetails(id) {
...
var IdeaPagesPage = function (_BasePage) {
    ...
    function IdeaPagesPage(client) {
        classCallCheck(this, IdeaPagesPage);

        var _this = possibleConstructorReturn(this, (IdeaPagesPage.__proto__ || Object.getPrototypeOf(IdeaPagesPage)).apply(this, arguments));
    ...
    createClass(IdeaPagesPage, [{
        ...
        value: function onReady() {
            ...
            return this._client.getIdea($('#IdeaId').val()).then(function (_ref) {
                var id = _ref.id,
                    pages = _ref.pages;
                ...
                knockout.applyBindings(viewModel, document.getElementById('idea-pages'));
            });
        }
    }]);
    return IdeaPagesPage;
}(BasePage);

var client = new ApiClient();
var page = new IdeaPagesPage(client);
page.init();
